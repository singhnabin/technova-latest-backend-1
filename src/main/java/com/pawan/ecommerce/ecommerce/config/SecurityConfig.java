package com.pawan.ecommerce.ecommerce.config;

import com.pawan.ecommerce.ecommerce.service.MyuserDetailsService;
import com.pawan.ecommerce.ecommerce.utils.JwtFilters;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
       ...
       // http.authorizeRequests().antMatchers("/api/admin/**").hasAnyRole("ADMIN");
        http.authorizeRequests().antMatchers("/api/user/**","/actuator/**","/swagger-ui.html/**").permitAll().anyRequest().authenticated();
